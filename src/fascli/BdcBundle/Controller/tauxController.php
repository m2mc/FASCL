...
use fascli\BdcBundle\Entity\taux;
use fascli\BdcBundle\Form\tauxType;
...
class tauxController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('fascliBdcBundle:taux')->findAll();
        return array(
            'entities' => $entities,
        );
    }
     ...
     * @Method("POST")
     * @Template("fascliBdcBundle:taux:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('fascliBdcBundle:taux')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $deleteForm = $this->createDeleteForm($id);
        $this->get('session')->getFlashBag()->add('notice3','Tu peux modifier maintenant!');
        return array(
            'entity'      => $entity,
    ...
    */
    private function createEditForm(taux $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Modifier le taux'));
     ...
     * @Method("PUT")
     * @Template("fascliBdcBundle:taux:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            $em->flush();
            $this->get('session')->getFlashBag()->add('notice2','TAUX MIS A JOUR');
